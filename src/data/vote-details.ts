...
export const voteResultDetails: VoteResultDetail[] = [
  {
    ...
    updatedAt: "2025-01-05T12:00:00+09:00",
    status: "open",
    ...
    home: {
      title: "今週の投票",
      description: [
        "国際的な動物福祉への関心が高まり三味線皮革の調達が注目されるなか、輸出入規制の強化が舞台や練習現場の運営にも影響し、職人と奏者が素材の切り替えをどう捉えるか地域でも議論が加速しています。",
      ],
    },
    options: [
      {
    ...
    voices: [
      {
        position: "賛成に近い声",
        summary: "舞台での安定性や音色維持を重視し、従来素材を使い続けたいと考える人たちの意見です。",
        highlights: [
          "舞台本番で破れるリスクを避けたいので、代替素材は耐久データが揃ってから導入したい。",
          "狩猟や畜産の副産物として適切に管理できるなら、従来素材を選び続けたい。",
        ],
      },
      {
        position: "慎重・中立の声",
        summary: "環境変化や作業工程の負担を気にしつつ、素材の比較検証や情報共有を求める声です。",
        highlights: [
          "海外公演では検疫手続きが複雑なため、ノンアニマル素材の試奏機会を増やして判断したい。",
          "素材の張り具合や乾燥スピードが変わるので、現場の研究投資と安定供給が必要。",
          "素材の裏打ちに使う糊や和紙も含めて見直し、関連する職種全体で協力したい。",
        ],
      },
      {
        position: "反対に近い声",
        summary: "動物福祉や社会的な説明責任を優先し、早期に代替素材へ移行したい人たちの意見です。",
        highlights: [
          "観客に素材の背景を説明できる資料を整え、転換の意義を共有したい。",
          "練習用は代替素材でも良いが、音量や耐久性の実証データを見ながら公式戦での採用を判断したい。",
        ],
      },
    ],
    area: {
  ...
  },
  {
    ...
    status: "open",
    startAt: "2025-01-05T08:00:00+09:00",
    endAt: "2025-11-30T23:59:59+09:00",
    voteType: "yesno",
    allowComment: false,
    minChoices: 1,
    maxChoices: 1,
    ...
    voices: [
      {
        position: "賛成に近い声",
        summary: "夜間の演出で来訪体験を広げたいという声が集まりました。",
        highlights: [
          "夜だけの透過光演出を試し、和紙の魅力を伝えたいが、片付けまで含めて段取りを固めたい。",
        ],
      },
      {
        position: "反対・慎重な声",
        summary: "生活リズムや安全面を気にかけ、段階的な検証を望む意見です。",
        highlights: [
          "延長開催は魅力的でも、スタッフ体制と撤収負担が増えるため無理のないスケジュールを求めたい。",
          "近隣住民の生活リズムや夜間交通が心配なので、自治会との合意形成を前提に試験導入したい。",
        ],
      },
    ],
    area: {
  ...
  },
  {
    ...
    updatedAt: "2025-01-08T15:00:00+09:00",
    status: "open",
    startAt: "2025-01-04T09:00:00+09:00",
    endAt: "2025-10-15T23:59:59+09:00",
    voteType: "single",
    allowComment: true,
    ...
    voices: [
      {
        position: "中立・調整を望む声",
        summary: "短期集中の魅力を感じつつ、基礎を丁寧に学びたいという意見が多く挙がりました。",
        highlights: [
          "半年で織れるようになる魅力はあるが、座学と実技をバランスよく深めたい。",
        ],
      },
      {
        position: "賛成に近い声",
        summary: "即戦力化を期待し、織り中心の集中カリキュラムに肯定的な声です。",
        highlights: [
          "現場で早く戦力になりたいので、織機操作に時間を割く短期カリキュラムを試したい。",
        ],
      },
      {
        position: "反対・慎重な声",
        summary: "師匠制度や個別指導を重視し、期間短縮に慎重な意見です。",
        highlights: [
          "細やかな技術伝承を守るには、個別指導の時間と指導側の負担を両立させる仕組みが必要。",
        ],
      },
    ],
    area: {
  ...
  },
  {
    ...
    updatedAt: "2025-01-12T11:30:00+09:00",
    status: "open",
    startAt: "2025-01-06T09:00:00+09:00",
    endAt: "2025-12-31T23:59:59+09:00",
    voteType: "multiple",
    allowComment: true,
    ...
    voices: [
      ...
      {
        position: "慎重な声",
        summary: "安全管理や受け入れ体制を整えたうえで実施したいという意見もあります。",
        highlights: [
          "大型炉の見学では安全レクチャーの徹底と少人数制の運用を組み合わせたい。",
        ],
      },
    ],
    area: {
