...
export const craftAreaDetails: CraftAreaDetail[] = [
  ...
  },
  {
    ...
    hero: {
      ...
      narrative:
        "荒川・台東エリアには、三味線の皮張り、棹づくり、鳴り物の調整など、多彩な専門職が連携する町工場が点在しています。演奏家や芸能の現場を支えつつ、新素材への挑戦や後継者育成にも力を注いでいます。",
      keywords: ["三味線皮革", "張師", "邦楽器ネットワーク"],
      stats: [
        {
          label: "邦楽器関連工房",
          value: "約40工房",
          note: "荒川区・台東区の関連事業者（2023年調査）",
        },
        {
          label: "年間張替え件数",
          value: "約3,500丁",
          note: "全国からの修理依頼を含む概算値",
        },
        {
          label: "主な楽器",
          value: "三味線・太鼓・鼓・篠笛",
      ...
      visual: {
        src: "/area-visuals/tokyo-wagakki.svg",
        alt: "三味線と張り道具をモチーフにしたイラスト",
      },
    },
    story: {
      title: "皮と音をめぐる対話が生まれるまち",
      highlights: [
        {
          title: "張師の共同ラボ『HAN-TO』",
          description:
            "複数の工房が共同で運営する素材研究ラボ。代替素材の張りテストや耐久性実験を行い、データを共有しています。",
        },
        {
          title: "演奏家との公開調整会",
          description:
            "舞台前に行う最終調整を公開し、音の変化を解説するプログラム。観客も音色の違いを体感できます。",
        },
        {
          title: "下町レザークロニクル",
          description:
            "革問屋の歴史と輸入規制の変遷を記録するプロジェクト。国際的な素材事情を学ぶ展示会を定期開催しています。",
        },
      ],
      timeline: [
        {
          ...
          title: "邦楽器協同組合が発足",
          description:
            "演奏家と職人のマッチングを目的に設立。資材の共同購入や技能講習が始まりました。",
        },
        {
          period: "1998年",
          title: "輸出入規制に対応した素材研究が本格化",
          description:
            "ワシントン条約の運用強化を受け、代替皮革と人工皮の実験がスタート。工業研究所との連携が進みます。",
        },
        {
          period: "2022年",
          title: "代替素材の公開試奏会を開催",
          description:
            "演奏家・研究者・観客を交えた試奏イベントを開催。記録映像と測定データをオンラインで配信しています。",
        },
      ],
    },
    workshops: [
      {
        title: "三味線の皮張り体験と音づくり講座",
        description:
          "張師と一緒に皮を張り、湿度管理と調弦のコツを学ぶプログラム。演奏家のミニライブ付き。",
        duration: "4時間",
        capacity: "6名まで",
        reservation: "開催日の10日前までにオンライン予約",
      },
      {
        title: "代替素材サウンドラボ見学",
        description:
          "人工皮革・植物由来素材などの張り替え工程を見学し、音声データを聴き比べる特別ツアー。研究者の解説付き。",
        duration: "2時間30分",
        capacity: "8名まで",
        reservation: "月1回開催・抽選制",
      },
    ],
    projects: [
      {
        title: "エシカルレザー・トレーサビリティ整備",
        status: "進行中",
        description:
          "皮革の調達履歴を可視化するため、捕獲情報や加工工程の記録をデジタル化。演奏家が確認できる仕組みを構築しています。",
        partner: "東京都立産業技術研究センター",
      },
      {
        title: "若手張師アカデミー",
        status: "参加者募集中",
        description:
          "張り技術と素材知識を体系的に学ぶ研修プログラム。演奏家の指導も受けながら現場で実地経験を積みます。",
      },
    ],
    artisans: [
      {
        name: "大橋 真由",
        role: "張師 / 素材研究コーディネーター",
        bio: "革製品メーカーから転身。データ分析を活かし、代替皮革の張り調整や音質評価手法を整備している。",
        specialty: "素材ごとの張力管理",
      },
      {
        name: "山田 惇",
        role: "三味線棹職人 / 音響設計",
        bio: "祖父の工房を継ぎ、演奏家の要望に合わせた棹の設計と調整を担当。デジタル計測機器を導入し微細な加工に挑戦。",
        specialty: "棹の反りと音響調整",
      },
    ],
    visiting: {
      bestSeason: "春と秋（湿度が安定し、工房見学がしやすい季節）",
      travelTips: [
        "工房内は皮や接着剤の匂いがするため、敏感な方はマスクの持参がおすすめです。",
        "見学時は演奏家が調整中の場合があるので、静かに見守りましょう。",
      ],
      access: "JR日暮里駅・三河島駅から徒歩圏。東京メトロ日比谷線三ノ輪駅からもアクセス可能。",
    },
    support: {
      website: "https://tokyo-wagakki.jp",
      instagram: "https://www.instagram.com/tokyo_wagakki",
      contactEmail: "hello@tokyo-wagakki.jp",
      note: "素材提供や共同研究の相談はメールにてお気軽にお問い合わせください。",
    },
  },
]
